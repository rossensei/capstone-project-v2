    ...
    <AuthenticatedLayout>
        <div class="py-4">
            <div class="w-full sm:px-6 lg:px-8">
                <h2 class="font-semibold text-3xl text-gray-700 leading-tight mb-4">Add an Item</h2>
                ...
                <div class="bg-white shadow rounded-md">
                    <div class="p-4">
                        ...
                        <div class="py-2 max-w-2xl">
                            <form @submit.prevent="form.post(route('item.store'))">
                                <div class="mb-4">
                                ...
                                <button type="submit" class="px-3 py-1.5 text-sm rounded-md bg-[#4e73df] hover:bg-[#4e72dfc0] text-white" :disabled="form.processing">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
